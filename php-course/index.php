...
// $preciscen_tekst = str_replace("lol","X",$preciscen_tekst);
// echo $preciscen_tekst;

// echo $preview . "...";

//Primer za velika slova 

// $tekst = "OvO je TrOl NEki";

// $velika_slova = strtolower($tekst);

// echo $velika_slova;

//Funkcije za upit da li tekst sadrzi nesto i funkcija trim

// $email = "   ovoje@neki.com   ";
